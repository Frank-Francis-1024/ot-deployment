...
# 18 "C:/Users/moral/.mchp_packs/Microchip/PIC18Fxxxx_DFP/1.4.151/xc8\pic\include\xc.h"
extern const char __xc8_OPTIM_SPEED;

extern double __fpnormalize(double);


# 13 "B:\Program Files\Microchip\xc8\v2.41\pic\include\c90\xc8debug.h"
#pragma intrinsic(__builtin_software_breakpoint)
extern void __builtin_software_breakpoint(void);

# 13 "B:\Program Files\Microchip\xc8\v2.41\pic\include\c90\stdint.h"
...
# 7 "C:/Users/moral/.mchp_packs/Microchip/PIC18Fxxxx_DFP/1.4.151/xc8\pic\include\builtins.h"
...
# 52 "C:/Users/moral/.mchp_packs/Microchip/PIC18Fxxxx_DFP/1.4.151/xc8\pic\include\proc\pic18f4550.h"
...
# 19 "C:/Users/moral/.mchp_packs/Microchip/PIC18Fxxxx_DFP/1.4.151/xc8\pic\include\pic18.h"
...
# 15 "B:\Program Files\Microchip\xc8\v2.41\pic\include\c90\stdbool.h"
typedef unsigned char bool;

# 91 "system.h"
void Init_PWM(void);
void __interrupt(low_priority) pwm_low_priority();

void Update_PWM(void);
void Update_Duty(volatile unsigned char red_Duty,volatile unsigned char green_Duty,volatile unsigned char blue_Duty);
...
# 4 "B:\Program Files\Microchip\xc8\v2.41\pic\include\c90\__size_t.h"
typedef unsigned size_t;

# 14 "B:\Program Files\Microchip\xc8\v2.41\pic\include\c90\string.h"
...
# 112
volatile unsigned char duty_R, duty_G, duty_B;
volatile unsigned int count = 0;

void Init_PWM(void)
{
TRISCbits.RC0 = TRISCbits.RC1 = TRISCbits.RC2 = 0;
duty_R = duty_G = duty_B = 127;
count = 0;
...
if(duty_R >= count){if(duty_R==0){LATCbits.LATC0 = 0;} else{ LATCbits.LATC0 = 1;}} else if(duty_R < count){LATCbits.LATC0 = 0;}
if(duty_G >= count){if(duty_G==0){LATCbits.LATC1 = 0;} else{ LATCbits.LATC1 = 1;}}else if(duty_G < count){LATCbits.LATC1 = 0;}
if(duty_B >= count){if(duty_B==0){LATCbits.LATC2 = 0;} else{ LATCbits.LATC2 = 1;}} else if(duty_B < count){LATCbits.LATC2 = 0;}
}
